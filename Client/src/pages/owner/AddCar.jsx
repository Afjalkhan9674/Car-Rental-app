...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Car" subTitle="Fill in ditails to list a new car for booking, including pricing, availability, and car specifications." />
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
           ...
           <select onChange={e=> setCar({...car, category:e.target.value})} value={car.category} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
            ...
            <option value="Van">Van</option>
             ...
             {/* car transmission, feul type seating capacity  */}
 ...
 <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='e.g A luxurious SUV with a spacious interior and a powerful engine.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChang
            e={e => setCar({ ...car, description: e.target.value })}></textarea>
          </div>
